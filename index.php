	...
	<div class="row">
		<nav id="nav-head" class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top d-print-none">
			<a class="navbar-brand" href="https://nimarahbar.com">
				<img class="img-thumbnail bg-dark" src="img/favicon.png"
				     alt="Nima Rahbar">
		...
		<div data-bs-spy="scroll" data-bs-target="#nav-head" data-bs-offset="0" class="scrollspy-example" tabindex="0">
			<div class="row mb-5">
					...
					<div class="card border-0 mb-5">
						...
						<div class="card-body">
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item d-flex align-items-center justify-content-evenly justify-content-sm-start border-0">
									<div class="d-flex align-items-center align-content-around justify-content-around gap-1 gap-sm-2">
										<div class="d-sm-flex align-items-sm-center text-center text-sm-start gap-sm-2">
								...
								<li class="list-group-item d-flex align-items-center border-0">
									<div class="d-flex align-items-center align-content-center">
										...
										<div class="lead">I have been living in Greece for almost <?php echo date("Y", time()) - 2018; ?> years and have full
											...
											spirit. My native language is Farsi and I speak English fluently and I am
			...
			<div class="divider row mb-5">
				<div class="col-12 col-sm-3">
					<h3 class="text-primary text-sm-end text-center"><a id="work-experience">WORK EXPERIENCE</a></h3>
				</div>
			...
			<div class="work-experience">
				...
				<div class="row mb-5">
					...
					<div class="col-12 col-sm-9">
						<div class="card border-0">
							<h4 class="card-header bg-transparent border-0 pt-0">Tehran Institute of Technology, Tehran
								(Iran)</h4>
							<div class="card-body">
								...
								<ul class="list-group list-group-flush">
									...
									<li class="list-group-item border-0">Advanced Web Development (PHP & MySQL).</li>
				...
				<div class="row mb-5">
					...
					<div class="col-12 col-sm-9">
						...
						<div class="card border-0">
							<h4 class="card-header bg-transparent border-0 pt-0">Salim Najafi Personal Portfolio</h4>
							<div class="card-body">
								<h6 class="card-title">UI & UX Design, Development with HTML5, CSS3, Bootstrap,
									JavaScript,
			...
			<div class="divider row mb-5">
				<div class="col-12 col-sm-3">
					<h3 class="text-primary text-sm-end text-center"><a id="personal-skills">PERSONAL SKILLS</a></h3>
				</div>
				<div class="col-12 col-sm-9 d-flex align-items-center">
					<div class="d-block w-100 bg-primary ms-3 d-none d-print-block" style="height: 5px;"></div>
					<div class="d-block w-100 bg-primary me-1 ms-3 d-print-none" style="height: 5px;"></div>
			...
			<div class="row mb-4">
				...
				<div class="col-12 col-sm-9 d-flex align-items-center">
					<div class="card border-0">
						<div class="card-body pt-0">
							<h5 class="card-title">Good communication skills in English gained through my experience as
								student
								in
								CIW</h5>
						</div>
				...
				<div class="col-12 col-sm-9 d-flex align-items-center">
					<div class="card border-0">
						<div class="card-body pt-0">
							<h5 class="card-title">
								<ul class="list-group list-group-flush">
									<li class="list-group-item pt-0 ps-0">SEO Increasing Applied Techniques, Tehran`s
										Dibagaran,
										Tehran,
										2017
									</li>
				...
				<div class="col-12 col-sm-9 d-flex align-items-center">
					<div class="card border-0">
						<div class="card-body pt-0">
							<h5 class="card-title">
								<ul class="list-group list-group-flush">
									<li class="list-group-item pt-0 ps-0">Instructor of The Year in Tehran Institute of
										Technology
										for
				...
				<div class="col-12 col-sm-9 d-flex align-items-center">
					<div class="card-group d-none d-print-none d-sm-block">
						<div class="row row-cols-1 row-cols-md-4 g-4">
                            ...
                            <div class="col">
								<div class="card">
									...
									<div class="card-body">
										...
										<p class="card-text"><small class="text-muted">Credential ID 5564059</small></p>
									</div>
								</div>
							</div>
							<div class="col">
								<div class="card">
									<img src="img/certificates/Certificate_5564064.jpg"
							...
							<div class="col">
								<div class="card">
									<img src="img/certificates/Certificate_5564060.jpg"
									     class="card-img-top" alt="CIW Web Design Specialist">
									<div class="card-body">
										<h5 class="card-title">CIW Web Design Specialist</h5>
										<p class="card-text"><small class="text-muted">Credential ID 5564060</small></p>
									</div>
								</div>
							</div>
							<div class="col">
								<div class="card">
									<img src="img/certificates/Certificate_5564062.jpg"
									     class="card-img-top" alt="CIW Web Design Professional">
									<div class="card-body">
										<h5 class="card-title">CIW Web Design Professional</h5>
										<p class="card-text"><small class="text-muted">Credential ID 5564062</small></p>
									</div>
								</div>
							</div>
							<div class="col">
								<div class="card">
									<img src="img/certificates/Certificate_5564063.jpg"
									     class="card-img-top" alt="CIW Professional">
									<div class="card-body">
										<h5 class="card-title">CIW Professional</h5>
										<p class="card-text"><small class="text-muted">Credential ID 5564063</small></p>
									</div>
								</div>
							</div>
							<div class="col">
								<div class="card">
									<img src="img/certificates/Certificate_5564065.jpg"
									     class="card-img-top" alt="CIW E-Commerce Specialist">
									<div class="card-body">
										<h5 class="card-title">CIW E-Commerce Specialist</h5>
										<p class="card-text"><small class="text-muted">Credential ID 5564065</small></p>
									</div>
								</div>
							</div>
							<div class="col">
								<div class="card">
									<img src="img/certificates/Certificate_5564061.jpg"
									     class="card-img-top" alt="Master CIW Designer">
									<div class="card-body">
										<h5 class="card-title">Master CIW Designer</h5>
										<p class="card-text"><small class="text-muted">Credential ID 5564061</small></p>
									</div>
								</div>
							</div>
							<div class="col">
								<div class="card">
									...
									<div class="card-body">
										...
										<p class="card-text"><small class="text-muted">Credential ID 434510</small></p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card border-0 d-sm-none d-print-block">
						<div class="card-body pt-0">
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item fs-6 ps-0">Master CIW Designer - Credential ID 5564061</li>
